...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/promo.js");
/******/ })
/************************************************************************/
/******/ ({
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.section-col--actions .btn').on('click', function () {
  var iframeId = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('iframe');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.iframe').removeClass('active');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#".concat(iframeId)).addClass('active');
